      ...
      {paginationUtil !== undefined && (
        <div className="pagination">
          <span>
            Page{" "}
            <strong>
              {paginationUtil.currentPage || 0} of{" "}
              {paginationUtil.totalPage || 0}
            </strong>
          </span>
          <button
            onClick={() => triggerPagination(paginationUtil.firstPageUrl)}
            disabled={!paginationUtil.firstPageUrl}
          >
            <MdFirstPage />
          </button>
          <button
            onClick={() => triggerPagination(paginationUtil.previousPageUrl)}
            disabled={!paginationUtil.previousPageUrl}
          >
            <FiChevronLeft />
          </button>
          <button
            onClick={() => triggerPagination(paginationUtil.nextPageUrl)}
